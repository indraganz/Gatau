...
const checkLimit = require('./plugins/checklim.js')
...
const { xnxxsearch, xnxxdl, wallpaper, pin, snapsave, ttstalk, chatbot, mediafireDl, pindl, llama2_ai, ttd, gpt3, gpt4, pixiv, pixivr18, vox, spe, askImage, ask, blackbox, gptRP, toAnime, openai, asupan } = require('./plugins/api.js');
